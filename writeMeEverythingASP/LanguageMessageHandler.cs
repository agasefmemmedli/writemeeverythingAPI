...
namespace writeMeEverythingASP
{
    public class LanguageMessageHandler : DelegatingHandler
    {
        private const string LangruRU = "ru-RU";
        private const string LangenEN = "en-EN";
        private const string LangazLatn = "az-Latn";

        private readonly List<string> _supportedLanguages = new List<string> { LangruRU, LangenEN, LangazLatn };
